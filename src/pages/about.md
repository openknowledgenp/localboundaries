...
**LocalBoundaries** is a project by [Open Knowledge Nepal](https://oknp.org) that publishes the administrative
...
civic-tech projects to find in an open format. LocalBoundaries fills that gap.
...
LocalBoundaries focuses on administrative boundaries. For other kinds of geospatial data, see:
